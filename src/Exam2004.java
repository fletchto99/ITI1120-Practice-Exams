...
public class Exam2004 {
    ...
    public static void main(String[] args) {
         ...
         * Should give 5,3,1,8
         * 
         * If it was formatted properly it would look something like
         * 
         * {5,3}
         * {1,8}
         * 
         * which would be the smaller 2d array (submatrix) of testArray
         */
    ...
    public static int[][] subMatrix(int[][] m, int row, int col) {
        ...
        int[][] submatrix = new int[m.length - row][m[0].length - col];// create an array with the lengths of rows and columns of the submatrix
